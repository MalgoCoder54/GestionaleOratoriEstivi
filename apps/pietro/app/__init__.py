...
def create_app():
    ...
    from .routes import anagrafica, pagamenti, configurazione, api, reporting
    app.register_blueprint(anagrafica.bp)
    app.register_blueprint(pagamenti.bp)
    ...
    def inject_asset_helpers():
        ...
        return {
            ...
            "has_resend_confirmation_flow": bool(app.config.get("RESEND_CONFIRMATION_FLOW_URL")),
        }
